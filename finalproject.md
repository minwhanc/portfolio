...
_**User Research and Interviews**_<br/>
The target audience of my story would ideally be executives in the media industry, particularly in SVoD. However, as it regards the changing trends in the media market, I believe anyone interested in the future of the media IT would also find this story compelling. Thus, to test the wireframes and storyboards to see if they are telling the information in the way I intend it to be, I interviewed a student aspired to be involved in entertainment industry management, just as I am, and an actor whom I did a conservatory program together at an acting school in New York City. The papers and reports I have written in the past often had words leading the content, and the graphics were there to support those words. However, I wanted the story to be built around the visuals, where visuals would represent the story's flow by punctuating the focal points, and words would define details that are not included in the graphics. Hence, my interview questions were constructed to see if the storyboard with only visualizations is successfully delivering the main points (ex. What can you tell from this storyboard?). And more importantly, if any of my visualizations are somewhat incomprehensible (ex. Are there any visualizations that seem unclear for any reason?).

Both of my interviewees seem to understand the storyline of my storyboard clearly. However, there were some suggestions and concerns that may help my story be far better received. For the chart "Households Are Unlikely to Subscribe to More Than Three SVoD Services," the data stopped in 2018. The graph alone did a decent job making the point, but since new major SVoD platforms (such as Disney+ or HBO Max) have launched after 2018, it was questionable if this steady trend is still ongoing. There also was a suggestion for the graphics visualized from survey data that it may be better to include the brief information of the survey (ex. number of respondents, location of the survey) beneath the Source section of each chart. Also, in the "Reduction" section, the way I positioned the graph "More Time With the Screen on the Hand" last made it seem weird. It seemed like introducing this graph first may have made the story flow better.

The suggestions were incredibly helpful in showing me aspects of my story that I was unaware of. To address the identified issues, I plan to find a more recent and appropriate dataset for the chart "Households Are Unlikely to Subscribe to More Than Three SVoD Services," and I will include a line of survey information on the charts based on survey data, but do it so concisely to avoid wordiness in my visualization. For the last suggestion made, I am rather careful to implement it into the section as it may distort my message. My original intent is, in brief words, "consumers want short content, and it may be 'associated' with their tendency to use handheld devices more often than other devices like TV." However, if I were to change the order as suggested, I am worried it may look like "people tend to use handheld devices more often than other devices, and it 'caused' them to prefer shorter content more than the longer ones." The second one may be true, although I highly doubt it. But besides its validity, because the confounding variables have not yet been identified and the causality has not yet been tested under random selections, that causal statement is not valid. The confusion that my interviewee pointed out may have been from my choice of the background (a person viewing SVoD on their phone). So, I plan to find (or create) an alternative background for that part of the section.
...
* [Fletcher-Brown, M. (2019, February 17). _black pencil on white printerpaper_. Unsplash](https://unsplash.com/photos/nN5L5GXKFz8)
* [freestocks. (2020, April 14). _person holding remote pointing at TV_. Unsplash](https://unsplash.com/photos/11SgH7U6TmI)
* [Hanschen, H. (2020, July 6). _woman in white shirt wearing blue headphones holding black microphone_. Unsplash](https://unsplash.com/photos/3Bz1yBpI3GI)
* [Hu, R. (2019, September 20). _FUTURE WORLD_. Unsplash](https://unsplash.com/photos/HOrhCnQsxnQ)
* [Kondrakov, A. (2020, August 14). _Couple fooling around_. Unsplash](https://unsplash.com/photos/s7Mc0yKTppo)
* [Maragos, A. (2019, July 6). _man wearing yellow shirt holding camera photo_. Unsplash](https://unsplash.com/photos/yvG2ZKJoVPY)
* [Maragos, A. (2019, July 13). _man using camera during nighttime photo_. Unsplash](https://unsplash.com/photos/GUjH1nOWVEs)
* [Morgan, C. (2017, June 13). _Photographing a donut_. Unsplash](https://unsplash.com/photos/VM6iQeQB4DU)
* [Neathery, B. (2017, July 5). _Man in a watch typing_. Unsplash](https://unsplash.com/photos/nPy0X4xew60)
* [Oazi, A. (2019, June 28). _movie theater interior_. Unsplash](https://unsplash.com/photos/KWOcA8_Vu10)
* [Ranisch, R. (2020, January 31). _Cambiio videoshoot / behind the scenes_. Unsplash](https://unsplash.com/photos/btquA1tPciQ)
* [Rose, J. (2016, November 4). _person taking photo of woman_. Unsplash](https://unsplash.com/photos/qWBoBpeOxjo)
* [Sivaram, M. (2020, April 14). _netflix all day_. Unsplash](https://unsplash.com/photos/yubCnXAA3H8)
* [Vick, A. (2019, February 26). _person holding white smartphone taking photo of woman wearing blue jeans_. Unsplash](https://unsplash.com/photos/pPV-kqfs5wA)
* [Villa, G. (2018, May 21). _man sitting on chair in front of condenser microphone_. Unsplash](https://unsplash.com/photos/KWrNwBE87EY)
* [Weiss, A. (2020, May 3). _Selfie while recording a TikTok_. Unsplash](https://unsplash.com/photos/UhSZEG0iLFY)
* [Xu, L. (2017, March 27). _person taking a photo of of open sea and sunset photo_. Unsplash](https://unsplash.com/photos/iMf7bvcIIog)

* [Amazon Prime Video logo. Wikipedia](https://en.wikipedia.org/wiki/File:Amazon_Prime_Video_logo.svg)
* [BritBox logo. Wikipedia](https://en.wikipedia.org/wiki/File:BritBox_logo.svg)
* [CBS All Access logo. Wikipedia](https://en.wikipedia.org/wiki/File:CBS_All_Access_Logo.svg)
* [Crunchyroll logo. Wikipedia](https://en.wikipedia.org/wiki/File:Crunchyroll.svg)
* [Disney+ logo. Walt Disney Direct-to-Consumer & International Media Center](https://dtcimedia.disney.com/disney-plus/images)
* [ESPN+ logo. Wikipedia](https://en.wikipedia.org/wiki/File:ESPN_Plus.svg)
* [HBO logo. Wikipedia](https://commons.wikimedia.org/wiki/File:HBO_logo.svg)
* [HBO Max logo. Wikipedia](https://en.wikipedia.org/wiki/File:HBO_Max_Logo.svg)
* [Hulu logo. Hulu Press](https://press.hulu.com/branding/)
* [Netflix logo. Netflix Brand Site](https://brand.netflix.com/en/assets/)
* [Peacock logo. Wikipedia](https://en.wikipedia.org/wiki/File:NBCUniversal_Peacock_Logo.svg)
* [YouTube Premium logo. Wikipedia](https://commons.wikimedia.org/wiki/File:YouTube_Premium_logo.svg)
